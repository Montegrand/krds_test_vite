...
<ul role="tablist">
<li aria-controls="helperTabpanel01" aria-selected="true" className="active" id="helperTab01" role="tab">
<button className="btn-tab" type="button">도움 <i className="sr-only created"> 선택됨</i></button>
</li>
<li aria-controls="helperTabpanel02" aria-selected="false" id="helperTab02" role="tab">
<button className="btn-tab" type="button">따라하기</button>
</li>
</ul>
</div>
...
<section aria-labelledby="helperTab01" className="tab-conts active" id="helperTabpanel01" role="tabpanel">
...
<section aria-labelledby="helperTab02" className="tab-conts" id="helperTabpanel02" role="tabpanel">
